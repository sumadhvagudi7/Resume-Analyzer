...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='mahisd@77',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://www.linkedin.com/in/sumadhava-anand-gudi-a8458318a" style="text-decoration: none; color: #021659;">Pruthviraj,Sangmesh,Sudhanva,Sumadhava</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.linkedin.com/in/sumadhava-anand-gudi-a8458318a" style="text-decoration: none; color: grey;">Sumadhava Anand Gudi</a> through 
            <a href="https://www.linkedin.com/in/sumadhava-anand-gudi-a8458318a" style="text-decoration: none; color: grey;">(Data Scientist)</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'sumadhva' and ad_password == 'mahisd77':
